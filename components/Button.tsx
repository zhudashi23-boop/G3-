...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-cyan-600 hover:bg-cyan-700 text-white focus:ring-cyan-500 shadow-sm border border-transparent",
    ...
    danger: "bg-red-50 hover:bg-red-100 text-red-600 focus:ring-red-500 border border-red-100"
  };
